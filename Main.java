...
{
    private connectfour.Controller controller;
    ...
    private void aboutMe()
    {
        ...
        alert.setHeaderText("Nakul Mahesh Bukkawar");
        alert.setContentText("Hi! I am Nakul, a developer focused on crafting" +
                ...
                " My other hobbies includes playing outdoor sports and pc games.");
